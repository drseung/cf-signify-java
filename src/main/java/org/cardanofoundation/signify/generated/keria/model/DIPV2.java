 ...
 */
@JsonPropertyOrder({
  DIPV2.JSON_PROPERTY_V,
  DIPV2.JSON_PROPERTY_T,
  DIPV2.JSON_PROPERTY_D,
  DIPV2.JSON_PROPERTY_I,
  DIPV2.JSON_PROPERTY_S,
  DIPV2.JSON_PROPERTY_KT,
  DIPV2.JSON_PROPERTY_K,
  DIPV2.JSON_PROPERTY_NT,
  DIPV2.JSON_PROPERTY_N,
  DIPV2.JSON_PROPERTY_BT,
  DIPV2.JSON_PROPERTY_B,
  DIPV2.JSON_PROPERTY_C,
  DIPV2.JSON_PROPERTY_A,
  DIPV2.JSON_PROPERTY_DI
})
@JsonTypeName("DIP_V_2")
...
public class DIPV2 {
  ...
  public DIPV2 v(@jakarta.annotation.Nonnull String v) {
  ...
  public DIPV2 t(@jakarta.annotation.Nonnull String t) {
  ...
  public DIPV2 d(@jakarta.annotation.Nonnull String d) {
  ...
  public DIPV2 i(@jakarta.annotation.Nonnull String i) {
  ...
  public DIPV2 s(@jakarta.annotation.Nonnull String s) {
  ...
  public DIPV2 kt(@jakarta.annotation.Nonnull Threshold kt) {
  ...
  public DIPV2 k(@jakarta.annotation.Nonnull List<String> k) {
    
    this.k = k;
    return this;
  }

  public DIPV2 addKItem(String kItem) {
    if (this.k == null) {
  ...
  public DIPV2 nt(@jakarta.annotation.Nonnull Threshold nt) {
  ...
  public DIPV2 n(@jakarta.annotation.Nonnull List<String> n) {
    
    this.n = n;
    return this;
  }

  public DIPV2 addNItem(String nItem) {
    if (this.n == null) {
  ...
  public DIPV2 bt(@jakarta.annotation.Nonnull String bt) {
  ...
  public DIPV2 b(@jakarta.annotation.Nonnull List<String> b) {
    
    this.b = b;
    return this;
  }

  public DIPV2 addBItem(String bItem) {
    if (this.b == null) {
  ...
  public DIPV2 c(@jakarta.annotation.Nonnull List<String> c) {
    
    this.c = c;
    return this;
  }

  public DIPV2 addCItem(String cItem) {
    if (this.c == null) {
  ...
  public DIPV2 a(@jakarta.annotation.Nullable Object a) {
  ...
  public DIPV2 di(@jakarta.annotation.Nonnull String di) {
  ...
  public boolean equals(Object o) {
    ...
    DIPV2 DIP_V_2 = (DIPV2) o;
    return Objects.equals(this.v, DIP_V_2.v) &&
        Objects.equals(this.t, DIP_V_2.t) &&
        Objects.equals(this.d, DIP_V_2.d) &&
        Objects.equals(this.i, DIP_V_2.i) &&
        Objects.equals(this.s, DIP_V_2.s) &&
        Objects.equals(this.kt, DIP_V_2.kt) &&
        Objects.equals(this.k, DIP_V_2.k) &&
        Objects.equals(this.nt, DIP_V_2.nt) &&
        Objects.equals(this.n, DIP_V_2.n) &&
        Objects.equals(this.bt, DIP_V_2.bt) &&
        Objects.equals(this.b, DIP_V_2.b) &&
        Objects.equals(this.c, DIP_V_2.c) &&
        Objects.equals(this.a, DIP_V_2.a) &&
        Objects.equals(this.di, DIP_V_2.di);
  }
