 ...
 */
@JsonPropertyOrder({
  ICPV1.JSON_PROPERTY_V,
  ICPV1.JSON_PROPERTY_T,
  ICPV1.JSON_PROPERTY_D,
  ICPV1.JSON_PROPERTY_I,
  ICPV1.JSON_PROPERTY_S,
  ICPV1.JSON_PROPERTY_KT,
  ICPV1.JSON_PROPERTY_K,
  ICPV1.JSON_PROPERTY_NT,
  ICPV1.JSON_PROPERTY_N,
  ICPV1.JSON_PROPERTY_BT,
  ICPV1.JSON_PROPERTY_B,
  ICPV1.JSON_PROPERTY_C,
  ICPV1.JSON_PROPERTY_A
})
@JsonTypeName("ICP_V_1")
...
public class ICPV1 {
  ...
  public ICPV1 v(@jakarta.annotation.Nonnull String v) {
  ...
  public ICPV1 t(@jakarta.annotation.Nonnull String t) {
  ...
  public ICPV1 d(@jakarta.annotation.Nonnull String d) {
  ...
  public ICPV1 i(@jakarta.annotation.Nonnull String i) {
  ...
  public ICPV1 s(@jakarta.annotation.Nonnull String s) {
  ...
  public ICPV1 kt(@jakarta.annotation.Nonnull Threshold kt) {
  ...
  public ICPV1 k(@jakarta.annotation.Nonnull List<String> k) {
    
    this.k = k;
    return this;
  }

  public ICPV1 addKItem(String kItem) {
    if (this.k == null) {
  ...
  public ICPV1 nt(@jakarta.annotation.Nonnull Threshold nt) {
  ...
  public ICPV1 n(@jakarta.annotation.Nonnull List<String> n) {
    
    this.n = n;
    return this;
  }

  public ICPV1 addNItem(String nItem) {
    if (this.n == null) {
  ...
  public ICPV1 bt(@jakarta.annotation.Nonnull String bt) {
  ...
  public ICPV1 b(@jakarta.annotation.Nonnull List<String> b) {
    
    this.b = b;
    return this;
  }

  public ICPV1 addBItem(String bItem) {
    if (this.b == null) {
  ...
  public ICPV1 c(@jakarta.annotation.Nonnull List<String> c) {
    
    this.c = c;
    return this;
  }

  public ICPV1 addCItem(String cItem) {
    if (this.c == null) {
  ...
  public ICPV1 a(@jakarta.annotation.Nullable Object a) {
  ...
  public boolean equals(Object o) {
    ...
    ICPV1 ICP_V_1 = (ICPV1) o;
    return Objects.equals(this.v, ICP_V_1.v) &&
        Objects.equals(this.t, ICP_V_1.t) &&
        Objects.equals(this.d, ICP_V_1.d) &&
        Objects.equals(this.i, ICP_V_1.i) &&
        Objects.equals(this.s, ICP_V_1.s) &&
        Objects.equals(this.kt, ICP_V_1.kt) &&
        Objects.equals(this.k, ICP_V_1.k) &&
        Objects.equals(this.nt, ICP_V_1.nt) &&
        Objects.equals(this.n, ICP_V_1.n) &&
        Objects.equals(this.bt, ICP_V_1.bt) &&
        Objects.equals(this.b, ICP_V_1.b) &&
        Objects.equals(this.c, ICP_V_1.c) &&
        Objects.equals(this.a, ICP_V_1.a);
  }
