 ...
 */
@JsonPropertyOrder({
  ICPV2.JSON_PROPERTY_V,
  ICPV2.JSON_PROPERTY_T,
  ICPV2.JSON_PROPERTY_D,
  ICPV2.JSON_PROPERTY_I,
  ICPV2.JSON_PROPERTY_S,
  ICPV2.JSON_PROPERTY_KT,
  ICPV2.JSON_PROPERTY_K,
  ICPV2.JSON_PROPERTY_NT,
  ICPV2.JSON_PROPERTY_N,
  ICPV2.JSON_PROPERTY_BT,
  ICPV2.JSON_PROPERTY_B,
  ICPV2.JSON_PROPERTY_C,
...
public class ICPV2 {
  ...
  public ICPV2 t(@jakarta.annotation.Nonnull String t) {
  ...
  public ICPV2 d(@jakarta.annotation.Nonnull String d) {
  ...
  public ICPV2 i(@jakarta.annotation.Nonnull String i) {
  ...
  public ICPV2 s(@jakarta.annotation.Nonnull String s) {
  ...
  public ICPV2 kt(@jakarta.annotation.Nonnull Threshold kt) {
  ...
  public ICPV2 k(@jakarta.annotation.Nonnull List<String> k) {
    
    this.k = k;
    return this;
  }

  public ICPV2 addKItem(String kItem) {
    if (this.k == null) {
  ...
  public ICPV2 nt(@jakarta.annotation.Nonnull Threshold nt) {
  ...
  public ICPV2 n(@jakarta.annotation.Nonnull List<String> n) {
    
    this.n = n;
    return this;
  }

  public ICPV2 addNItem(String nItem) {
    if (this.n == null) {
  ...
  public ICPV2 bt(@jakarta.annotation.Nonnull String bt) {
  ...
  public ICPV2 b(@jakarta.annotation.Nonnull List<String> b) {
    
    this.b = b;
    return this;
  }

  public ICPV2 addBItem(String bItem) {
    if (this.b == null) {
  ...
  public ICPV2 c(@jakarta.annotation.Nonnull List<String> c) {
    
    this.c = c;
    return this;
  }

  public ICPV2 addCItem(String cItem) {
    if (this.c == null) {
  ...
  public ICPV2 a(@jakarta.annotation.Nullable Object a) {
  ...
  public boolean equals(Object o) {
    ...
    ICPV2 ICP_V_2 = (ICPV2) o;
    return Objects.equals(this.v, ICP_V_2.v) &&
        Objects.equals(this.t, ICP_V_2.t) &&
        Objects.equals(this.d, ICP_V_2.d) &&
        Objects.equals(this.i, ICP_V_2.i) &&
        Objects.equals(this.s, ICP_V_2.s) &&
        Objects.equals(this.kt, ICP_V_2.kt) &&
        Objects.equals(this.k, ICP_V_2.k) &&
        Objects.equals(this.nt, ICP_V_2.nt) &&
        Objects.equals(this.n, ICP_V_2.n) &&
        Objects.equals(this.bt, ICP_V_2.bt) &&
        Objects.equals(this.b, ICP_V_2.b) &&
        Objects.equals(this.c, ICP_V_2.c) &&
        Objects.equals(this.a, ICP_V_2.a);
  }
